  ...
  if (plugins.calendar.length) {
    for (i = 0; i < plugins.calendar.length; i++) {
      ...
      calendarItem.rdCalendar({
        ...
        month: calendarItem.attr("data-months") ? calendarItem.attr("data-months").split(/\s?,\s?/i) : ['Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre']
      });
    }
  }
