...
use \AppBundle\Entity\PopArticlesAnalyticsMonth;
use \AppBundle\Entity\Category;


$GLOBALS['VIEW_ID'] = '*******';
$GLOBALS['KEY_FILE_LOCATION'] = __DIR__ . '/credentials.json';
$GLOBALS['start'] = '30daysAgo';
$GLOBALS['stop'] = 0;
$GLOBALS['analytics'] = $analyticsReports;


class AnalyticsMonth extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('update:analytics_month')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $qb->delete('AppBundle:PopArticlesAnalyticsMonth', 'poparticles')
            ->getQuery()
            ->execute();
        ...
        foreach($categorys as $category)
        {
            ...
            foreach ($fResults as $elem)
            {
                ...
                if ($article == null)
                    continue;
                $popArticlesAnalytics = new PopArticlesAnalyticsMonth();
