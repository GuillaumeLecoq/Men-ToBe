...
/**
 * PopArticlesAnalyticsMonth
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\PopArticlesAnalyticsMonthRepository")
 */

class PopArticlesAnalyticsMonth
{
    /**
     * @var integer
     *
     ...
     *
     * @return PopArticlesAnalyticsMonth
     */
